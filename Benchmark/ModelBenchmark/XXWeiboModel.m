...
#define XXModelSynthCoderAndHash \
...
@implementation XXWeiboPictureMetadata
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"cutType" : @"cut_type"};
}
XXModelSynthCoderAndHash
@end

@implementation XXWeiboPicture
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"picID" : @"pic_id",
             @"keepSize" : @"keep_size",
             @"photoTag" : @"photo_tag",
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"picIds" : [NSString class],
             @"picInfos" : [XXWeiboPicture class],
             @"urlStruct" : [XXWeiboURL class]};
}
XXModelSynthCoderAndHash
@end
