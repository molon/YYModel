...
@interface XXWeiboPictureMetadata : NSObject <NSCoding, NSCopying>
...
@protocol XXWeiboPicture
@end
@interface XXWeiboPicture : NSObject <NSCoding, NSCopying>
@property (nonatomic, strong) NSString *picID;
@property (nonatomic, strong) NSString *objectID;
@property (nonatomic, assign) int photoTag;
@property (nonatomic, assign) BOOL keepSize;
@property (nonatomic, strong) XXWeiboPictureMetadata *thumbnail;
@property (nonatomic, strong) XXWeiboPictureMetadata *bmiddle;
@property (nonatomic, strong) XXWeiboPictureMetadata *middlePlus;
@property (nonatomic, strong) XXWeiboPictureMetadata *large;
@property (nonatomic, strong) XXWeiboPictureMetadata *largest;
@property (nonatomic, strong) XXWeiboPictureMetadata *original;
@end

@protocol XXWeiboURL
@end
@interface XXWeiboURL : NSObject <NSCoding, NSCopying>
...
@interface XXWeiboUser : NSObject <NSCoding, NSCopying>
...
@interface XXWeiboStatus : NSObject <NSCoding, NSCopying>
@property (nonatomic, assign) uint64_t statusID;
@property (nonatomic, strong) NSString *idstr;
@property (nonatomic, strong) NSString *mid;
@property (nonatomic, strong) NSString *rid;
@property (nonatomic, strong) NSDate *createdAt;
@property (nonatomic, strong) XXWeiboUser *user;
@property (nonatomic, assign) int32_t userType;
@property (nonatomic, strong) NSString *text;

@property (nonatomic, strong) NSArray<NSString *><NSString> *picIds;
@property (nonatomic, strong) NSDictionary<NSString *,XXWeiboPicture *><XXWeiboPicture> *picInfos;
@property (nonatomic, strong) NSArray<XXWeiboURL *><XXWeiboURL> *urlStruct;
//@property (nonatomic, strong) NSArray *picIds;        /// Array<NSString>
//@property (nonatomic, strong) NSDictionary *picInfos; /// Dic<NSString, XXWeiboPicture>
//@property (nonatomic, strong) NSArray *urlStruct;     ///< Array<XXWeiboURL>
