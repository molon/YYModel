...
@interface XXTestModelHashModel : NSObject <NSCopying, NSCoding>
...
@implementation XXTestModelHashModel
...
@interface XXTestEqualAndHash : XCTestCase

@end

@implementation XXTestEqualAndHash

- (void)testHash {
    XXTestModelHashModel *model1 = [XXTestModelHashModel new];
    XXTestModelHashModel *model2 = [XXTestModelHashModel new];
...
- (void)testCopying {
    XXTestModelHashModel *model1 = [XXTestModelHashModel new];
    XXTestModelHashModel *model2 = nil;
