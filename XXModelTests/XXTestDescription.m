...
@interface XXTestDescriptionModel : NSObject
...
@implementation XXTestDescriptionModel
- (NSString *)description {
    return [self xx_modelDescription];
}
@end
...
@interface XXTestDescription : XCTestCase

@end

@implementation XXTestDescription

- (void)testDescription {
    XXTestDescriptionModel *model = [XXTestDescriptionModel new];
    model.string = @"test";
    model.intValue = 100;
    ...
    for (int i = 0; i < 2; i++) {
        XXTestDescriptionModel *sub = [XXTestDescriptionModel new];
        sub.intValue = i;
